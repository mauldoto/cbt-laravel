  ...
  <ul class="nav">
    ...
    <li class="nav-item {{ active_class(['/guru']) }}">
      ...
      <div class="collapse {{ show_class(['guru']) }}" id="teacher-menu">
        <ul class="nav flex-column sub-menu">
          ...
          <li class="nav-item {{ active_class(['/']) }}"> <a class="nav-link" href="pages/ui-features/dropdowns.html">List</a></li>
        </ul>
      </div>
    </li>
    <li class="nav-item {{ active_class(['/siswa']) }}">
      ...
      <div class="collapse {{ show_class(['siswa']) }}" id="student-menu">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item {{ active_class(['/']) }}"> <a class="nav-link" href="pages/ui-features/buttons.html">Create</a></li>
          <li class="nav-item {{ active_class(['/']) }}"> <a class="nav-link" href="pages/ui-features/dropdowns.html">List</a></li>
        </ul>
      </div>
    </li>
